...
contract DeployDeterministicMerkleFactories is BaseScript {
        ...
        )
    {
        ...
        merkleFactoryInstant = new SablierMerkleFactoryInstant{ salt: SALT }(initialAdmin);
        merkleFactoryLL = new SablierMerkleFactoryLL{ salt: SALT }(initialAdmin);
        merkleFactoryLT = new SablierMerkleFactoryLT{ salt: SALT }(initialAdmin);
        merkleFactoryVCA = new SablierMerkleFactoryVCA{ salt: SALT }(initialAdmin);
    }
}
