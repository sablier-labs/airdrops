...
import { Merkle_Fork_Test } from "./Merkle.t.sol";

abstract contract MerkleInstant_Fork_Test is Merkle_Fork_Test {
    /*//////////////////////////////////////////////////////////////////////////
                                    CONSTRUCTOR
    //////////////////////////////////////////////////////////////////////////*/

    constructor(IERC20 tokenAddress) Merkle_Fork_Test(tokenAddress) { }
    ...
    function testForkFuzz_MerkleInstant(Params memory params) external {
        ...
        vars.expectedMerkle = computeMerkleInstantAddress({
        ...
        emit ISablierMerkleFactoryInstant.CreateMerkleInstant({
            merkleInstant: ISablierMerkleInstant(vars.expectedMerkle),
        ...
        assertEq(address(merkleInstant), vars.expectedMerkle, "MerkleInstant contract does not match computed address");
