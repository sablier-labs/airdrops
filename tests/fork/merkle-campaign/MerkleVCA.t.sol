...
abstract contract MerkleVCA_Fork_Test is Merkle_Fork_Test {
    /*//////////////////////////////////////////////////////////////////////////
                                    CONSTRUCTOR
    //////////////////////////////////////////////////////////////////////////*/
    ...
    function testForkFuzz_MerkleVCA(Params memory params, MerkleVCA.Timestamps memory timestamps) external {
        ...
        vars.expectedMerkle = computeMerkleVCAAddress({
        ...
        emit ISablierMerkleFactoryVCA.CreateMerkleVCA({
            merkleVCA: ISablierMerkleVCA(vars.expectedMerkle),
        ...
        assertEq(address(merkleVCA), vars.expectedMerkle, "MerkleVCA contract does not match computed address");
