...
abstract contract MerkleLT_Fork_Test is Merkle_Fork_Test {
    /*//////////////////////////////////////////////////////////////////////////
                                    CONSTRUCTOR
    //////////////////////////////////////////////////////////////////////////*/
    ...
    function testForkFuzz_MerkleLT(Params memory params, uint40 startTime) external {
        ...
        vars.expectedMerkle = computeMerkleLTAddress({
        ...
        emit ISablierMerkleFactoryLT.CreateMerkleLT({
            merkleLT: ISablierMerkleLT(vars.expectedMerkle),
        ...
        assertEq(address(merkleLT), vars.expectedMerkle, "MerkleLT contract does not match computed address");
