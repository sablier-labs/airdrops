...
contract Constructor_MerkleInstant_Integration_Test is MerkleInstant_Integration_Shared_Test {
    function test_Constructor() external {
        ...
        SablierMerkleInstant constructedInstant = new SablierMerkleInstant(merkleInstantConstructorParams());
        ...
        assertEq(address(constructedInstant.FACTORY()), address(merkleFactoryInstant), "factory");
