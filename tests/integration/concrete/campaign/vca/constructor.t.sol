...
contract Constructor_MerkleVCA_Integration_Test is MerkleVCA_Integration_Shared_Test {
    function test_Constructor() external {
        ...
        // SablierMerkleVCA
        assertEq(constructedVCA.END_TIME(), RANGED_STREAM_END_TIME, "vesting end time");
        assertEq(constructedVCA.START_TIME(), RANGED_STREAM_START_TIME, "vesting start time");
